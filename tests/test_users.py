...
class TestUser(BaseTestCase):
    ...
    def test_user_registration(self):
        with self.client:
            response = self.client.post('register', data=dict(
                username='Michael', email='python@python.com',
            ...
            user = User.query.filter_by(email='python@python.com').first()
    ...
    def test_check_password(self):
        ...
        self.assertTrue(check_password_hash(user.password, 'admin'))
